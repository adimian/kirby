...
@click.option(
    ...
    type=int,
    default=3,
    help="Number of runners need to start"
)
@click.option(
    "--arbiter",
    type=int,
    default=3,
    help="Number of arbiters need to start"
)
def supervisor(name, window, wakeup, runner, arbiter):
    run_supervisor(name, window, wakeup, runner, arbiter)
